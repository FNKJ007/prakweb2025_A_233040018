...
<body class="flex flex-col min-h-screen">
    <nav class="bg-pink-800 p-4 mb-4 flex justify-between items-center">
        <div class="flex gap-4">
            ...
            <a href="/service" class="text-white hover:text-gray-200">Service</a>
    ...
    <footer class="bg-black-200 text-center py-4 mt-10 text-sm text-gray-600">
        <p>Copyright © 2025 FNKJ</p>
    </footer>
</body>
